...
match_data_file_cricinfo$Date <- as.Date(match_data_file_cricinfo$Match.Date, format = "%d-%b-%y")
...
hist(bowling_impact$TotalBowlingImpact, breaks = 50, main = "Fig 1: Bowling and Batting Impact Distribution", xlab = "Total Impact", col = rgb(0,0,1,1/4))
...
hist(battingranking$BattingScale2, col = "blue", main = "Venue Batting Scale Distribution", xlab = "Batting Scale")
...
print(paste("Best Lambda:", round(overallbestlambda, 4), 
            ...
            "LogLoss:", round(best_logloss_lr, 4)))
...
print(paste("Accuracy value on test set: ", round(best_acc_lr * 100, 2), "%"))
...
print(paste("Best RF model - mtry:", overallbestmtry_rf, 
            ...
            " LogLoss:", round(best_logloss_rf, 4)))
...
print(paste("Best SVM model - C:", overallbestC_svm, 
            ...
            " LogLoss:", round(best_logloss_svm, 4)))
...
knitr::include_graphics("../images/app/Example_Comparison.png")
```
## Past Match Model Output
...
knitr::include_graphics("../images/app/Past_Match_Model_Output.png")
```
...
knitr::include_graphics("../images/app/Future_Match_Prediction.png")
```
