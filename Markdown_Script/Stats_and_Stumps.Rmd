...
hist(bowlingranking$BowlingScale2, col = "red", main = "Venue Bowling Scale Distribution")
...
>>>>>>> 0f2cba1 (Addition of image files for easy figure access and markdown knit)
```
## Past Match Model Output
